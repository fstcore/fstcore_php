...
class Payeer
{
	...
	public function __construct()
	{
		...
		$this->url = $this->configjson->payeer->url;
		$this->key = $this->configjson->payeer->key;
		$this->secretKey = $this->configjson->payeer->secretKey;
		$this->urlpublic = $this->configjson->payeer->urlpublic;
	}
